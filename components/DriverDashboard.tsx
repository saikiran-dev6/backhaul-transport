...
type Trip = {
  ...
  passengerBookings: Array<{ id: string; seatsBooked: number; fare: number; bookingStatus: string; passenger: { fullName: string } }>;
  goodsBookings: Array<{ id: string; price: number; deliveryStatus: string; goodsRequest: { goodsType: string; weightKg: number; pickupName: string; dropName: string } }>;
};
                    ...
                    <div>
                      ...
                      {trip.passengerBookings.length ? (
                        trip.passengerBookings.map((booking) => (
                          <div key={booking.id} className="mb-2 rounded-xl bg-brand-50 p-3 text-sm">
                    ...
                    <div>
                      ...
                      {trip.goodsBookings.length ? (
                        trip.goodsBookings.map((booking) => (
                          <div key={booking.id} className="mb-2 rounded-xl bg-eco-50 p-3 text-sm">
